  ...
  return (
    <div className="flex flex-col items-center my-10">
      <button
        ...
        className="text-white bg-gradient-to-r from-indigo-500 via-purple-500 to-pink-500 text-xl font-bold px-8 py-4 rounded-2xl shadow-xl hover:scale-105 transition-transform duration-300"
      >
